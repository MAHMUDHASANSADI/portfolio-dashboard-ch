...
namespace Modules\AwardCategory\App\Http\Controllers;
...
class AwardCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('awardcategory::award_categories.index', [
    ...
    {
        return view('awardcategory::award_categories.create'); 
    }
    ...
    public function show($id)
    {
        ...
        return view('awardcategory::award_categories.show', compact('award_category')); // Pass to view
    }
    ...
    public function edit($id)
    {
        ...
        return view('awardcategory::award_categories.edit', compact('award_categories')); // Pass to edit form
    }
